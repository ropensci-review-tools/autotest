...
[`autotest_package()`
function](https://ropensci-review-tools.github.io/autotest/reference/autotest_package.html)
...
demonstrated in the
[`README`](https://ropensci-review-tools.github.io/autotest/), information on
all tests implemented within the package can be obtained by calling the
[`autotest_types()`
function](https://ropensci-review-tools.github.io/autotest/reference/autotest_types.html).
...
= FALSE)`](https://ropensci-review-tools.github.io/autotest/reference/autotest_package.html).
