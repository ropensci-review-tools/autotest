...
```{r at-cor-notest, eval = FALSE}
x <- autotest_package (package = "stats", functions = "cor")
```
...
the function on a specified package, or subset of functions thereof, will
return data on tests which would be performed on that package or those
functions, without actually running the tests.
