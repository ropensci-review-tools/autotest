...
[![Codecov test coverage](https://codecov.io/gh/ropensci-review-tools/autotest/graph/badge.svg)](https://app.codecov.io/gh/ropensci-review-tools/autotest)
[![Project Status:
Active](https://www.repostatus.org/badges/latest/active.svg)](https://www.repostatus.org/#active)
[![CRAN_Status_Badge](https://www.r-pkg.org/badges/version/autotest)](https://cran.r-project.org/package=autotest/) 
[![CRAN Downloads](https://cranlogs.r-pkg.org/badges/grand-total/autotest?color=orange)](https://cran.r-project.org/package=autotest)
<!-- badges: end -->
...
`autotest` is [on CRAN](https://cran.r-project.org/package=autotest), so can be
installed with
...
And then calling `install.packages()`. The package can also be installed from
many other remote locations using any one of the following lines:
...
warnings, and other diagnostic messages issued during package `autotest`-ing.
...
4. [`mutant`](https://github.com/sckott/mutant) for mutation of R code itself
